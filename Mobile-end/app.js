...
app.use(function(req, res, next) {
    ...
    if (agentID)
        res.redirect("http://www.51icb.com");
    else
        next();
});
...
var layout = require('./routes/layout.js'); // layout页
var AboutUs = require('./routes/AboutUs.js'); // 关于我们
var Product = require('./routes/Product.js'); // 旗下产品
var Business = require('./routes/Business.js'); // 商务合作
var Question = require('./routes/Question.js'); // 常见问题
var Contact = require('./routes/Contact.js'); // 常见问题
var join_us = require('./routes/join_us.js'); // 加入我们

app.use('/captcha', captcha);

app.use('/', index); // 首页
app.use('/layout', layout); // layout页
app.use('/AboutUs', AboutUs); // 关于我们
app.use('/Product', Product); // 旗下产品
app.use('/Business', Business); // 商务合作
app.use('/Question', Question); // 常见问题
app.use('/Contact', Contact); // 常见问题
app.use('/join_us', join_us); // 加入我们
